...
{
public:  // variables
	static const int scanlclks = 456, mode0clks = 201, mode1clks = 4560, 
		mode2clks = 77, mode3clks = 169, screenrclks = 70224;
	
	int scanlcounter, m0clksleft, m1clksleft, m2clksleft, m3clksleft, srclksleft;
